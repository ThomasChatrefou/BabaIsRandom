...
public class DebugCommandMenuEditor : EditorWindow
{
    ...
    private void LogCommandNotImplemented(string commandName)
    {
        Debug.Log(commandName + "is not implemented in this project");
    }

    private void KillAllEnemies()
    {
        LogCommandNotImplemented("KillAllEnemies");
    ...
    {
        LogCommandNotImplemented("TogglePlayerInvulnerability");
        //if (_player != null)
        //{
    ...
    {
        LogCommandNotImplemented("TogglePlayerDamages");
        //if (_player != null)
        //{
